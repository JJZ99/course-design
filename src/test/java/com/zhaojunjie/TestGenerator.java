...
/**
 * 逆向工厂根据数据库自动生成mapper、controller、service、bean
 */
public class TestGenerator {
    ...
    public void testGenerator() {
        ...
        globalConfig.setAuthor("zjj")
                .setOutputDir("D:\\Java_File2.0\\coursedesignv2\\src\\main\\java")//设置输出路径
        ...
        dataSourceConfig.setDriverName("com.mysql.cj.jdbc.Driver").setUrl("jdbc:mysql://localhost:3306/course_design?serverTimezone=UTC")
        ...
        packageConfig.setParent("com.zhaojunjie").setMapper("mapper")
